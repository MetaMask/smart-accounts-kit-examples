...
2. **Web3Auth Client ID**: Create a new project on the [Web3Auth dashboard](https://dashboard.web3auth.io/), and get your Client ID. 
...
To learn more about MetaMask Smart Accounts, see the following resources:
