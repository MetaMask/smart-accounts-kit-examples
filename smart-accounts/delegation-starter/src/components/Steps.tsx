      ...
      {step === 4 && (
        <>
          <p className="text-gray-700 dark:text-white/70 max-w-4xl leading-relaxed">
            ...
            be used to transfer 0.001 ETH on delegator's behalf. The signed
            delegation will be persisted in localStorage.
            <br />
            <br />
            The delegator must specify a scope to limit the authority of the delegation. {" "}
            <a
            ...
            >
              See how to use the delegation scope
            </a>
            .
          </p>
